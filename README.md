...
### 6.2. Возможность работы с Инструментами / Tools

-> **имя пользователя внизу слева** –> **«Панель администратора»** -> **вверху "Настройки"** -> **слева "Модели"** -> **"карандаш" напротив названия нужной**
...
```
Не используй встроенный поиск и не анализируй содержимое приложенного файла.
Используй инструмент get_file_index для анализа файла.
Необходимо получить на выходе не имя файла, а UUID  
```
...
```
Не анализируй файл через внутренние методы.
